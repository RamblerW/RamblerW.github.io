    ...
    a.fn.typewriter = function() {
        this.each(function() {
            var d = a(this),
                ...
                b = 0;
            d.html("");
            var e = setInterval(function() { var f = c.substr(b, 1); if (f == "<") { b = c.indexOf(">", b) + 1 } else { b++ } d.html(c.substring(0, b) + (b & 1 ? "_" : "")); if (b >= c.length) { clearInterval(e) } }, 75)
        });
        return this
    }
})(jQuery);
...
function showMessages() {
    ...
    $("#messages_old").fadeIn(2000, function() { showLoveU_old() })
}

function adjustWordsPosition() {
    $("#words").css("position", "absolute");
    $("#words").css("top", $("#garden").position().top + 225);
    $("#words").css("left", $("#garden").position().left + 70);
    $("#words_old").css("position", "absolute");
    $("#words_old").css("top", $("#garden").position().top + 83);
    $("#words_old").css("left", $("#garden").position().left + 71);
}
...
function showLoveU_old() { $("#loveu_old").fadeIn(1000) };